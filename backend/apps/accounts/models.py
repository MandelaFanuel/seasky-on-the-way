...
class CustomUser(AbstractUser):
    ...
    id_type = models.CharField(
        max_length=20,
        choices=IdTypes.choices,
        null=True,
        blank=True,
        verbose_name=_("Type de pièce d'identité"),
    )
    ...
    id_no_expiry = models.BooleanField(
        default=False,
        verbose_name=_("Pas de date d'expiration"),
    )

    id_document_name = models.CharField(
        max_length=200,
        null=True,
        blank=True,
    ...
    colline_or_quartier = models.CharField(
        max_length=100,
        null=True,
        blank=True,
        verbose_name=_("Colline/Quartier"),
    )
    ...
    emergency_contact_relationship = models.CharField(
        ...
        null=True,
        blank=True,
        verbose_name=_("Relation avec le contact"),
    )

    # -------------------------------------------------------------------------
    # Entreprise (pour fournisseurs/partenaires/entreprises)
    # -------------------------------------------------------------------------
    ...
    business_entity_type = models.CharField(
        max_length=20,
        choices=BusinessEntityTypes.choices,
        null=True,
        blank=True,
        verbose_name=_("Type d'entité commerciale"),
    )
    ...
    business_doc_expiry_date = models.DateField(
        null=True,
        blank=True,
        verbose_name=_("Date d'expiration des documents"),
    )

    # -------------------------------------------------------------------------
    # Boutique (pour commerçants)
    # -------------------------------------------------------------------------
    boutique_type = models.CharField(
        max_length=20,
        choices=BoutiqueTypes.choices,
        null=True,
        blank=True,
        verbose_name=_("Type de boutique"),
    )

    boutique_services = models.JSONField(
        default=list,
        null=True,
        blank=True,
        verbose_name=_("Services proposés"),
    )

    # -------------------------------------------------------------------------
    # Livraison (pour livreurs)
    # -------------------------------------------------------------------------
    delivery_vehicle = models.CharField(
        max_length=20,
        choices=DeliveryVehicles.choices,
        null=True,
        blank=True,
        verbose_name=_("Véhicule de livraison"),
    )
    ...
    vehicle_registration = models.CharField(
        ...
        null=True,
        blank=True,
        verbose_name=_("Immatriculation du véhicule"),
    )
    ...
    preferred_delivery_time = models.CharField(
        ...
        null=True,
        blank=True,
        verbose_name=_("Horaire de livraison préféré"),
    )

    delivery_instructions = models.TextField(
        null=True,
        blank=True,
        verbose_name=_("Instructions de livraison"),
    )

    # -------------------------------------------------------------------------
    # Paiement
    # -------------------------------------------------------------------------
    lumicash_msisdn = models.CharField(
        max_length=30,
        null=True,
        blank=True,
        verbose_name=_("Numéro Lumicash"),
    )
    ...
    accepted_terms = models.BooleanField(
        default=False,
        verbose_name=_("Conditions générales acceptées"),
    )

    accepted_contract = models.BooleanField(
        default=False,
        verbose_name=_("Contrat accepté"),
    )
    ...
    signature = models.ImageField(
        upload_to="user_signatures/%Y/%m/%d/",
        null=True,
        blank=True,
    ...
    kyc_verified_at = models.DateTimeField(
        null=True,
        blank=True,
        verbose_name=_("Date de vérification KYC"),
    )
    ...
    def save(self, *args, **kwargs):
        ...
        # ✅ Matricule Agent (NOUVEAU) - sans casser le reste
...
class UserDocument(models.Model):
    ...
    file_size = models.IntegerField(
        null=True,
        blank=True,
        verbose_name=_("Taille du fichier (KB)"),
    )
