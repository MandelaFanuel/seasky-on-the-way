...
const AlertBanner: React.FC<AlertBannerProps> = ({
  ...
  return (
    <div className={`${styles.container} border rounded-lg p-4 animate-fadeIn ${className}`}>
      <div className="flex items-start">
        ...
        {persistent && (
          <div className="ml-3">
            <span className="text-xs font-medium px-2 py-1 rounded bg-opacity-20 bg-gray-800 text-gray-600">
              Important
            </span>
          </div>
        )}
